...
import bot.modules.helper_funcs.fun_strings as fun
from bot import DEV_USERS, LOGGER, SUDO_USERS, SUPPORT_USERS, dispatcher
from bot.modules.disable import (
...
`/decide` can be also used with regex like: `bot What? <question>: randomly answer "Yes, No" etc.`
...
DECIDE_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"(?i)(bot)"), decide, friendly="decide", run_async=True
)
