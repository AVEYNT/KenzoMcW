...
from bot import app, Command, OWNER_ID, edrep

@app.on_message(filters.user(OWNER_ID) & filters.command("ls", Command))
...
@app.on_message(filters.user(OWNER_ID) & filters.command("upload", Command))
...
@app.on_message(filters.user(OWNER_ID) & filters.command("dl", Command))
...
@app.on_message(filters.user(OWNER_ID) & filters.command("download", Command))
...
@app.on_message(filters.user(OWNER_ID) & filters.command("direct", Command))
