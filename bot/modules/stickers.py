...
GETSTICKER_HANDLER = CommandHandler("getsticker", getsticker, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user)
KANG_HANDLER = CommandHandler("kang", kang, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True)
STICKERS_HANDLER = CommandHandler("stickers", cb_sticker, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True)
