...
class GoogleDriveHelper:
    ...
    def __upload_empty_file(self, path, file_name, mime_type, parent_id=None):
        ...
        file_metadata = {
            'name': file_name,
            'description': 'Uploaded by KenzoMcW',
            'mimeType': mime_type,
        }
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        buttons.buildbutton("Tautan Indeks", url)
                ...
                msg += f'<b>Nama Berkas: </b><code>{file.get("name")}</code>'
                ...
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        buttons.buildbutton("Tautan Indeks", siurl)
                        if VIEW_LINK:
                            buttons.buildbutton("Lihat Tautan", siurls)
                    else:
                        buttons.buildbutton("Tautan Indeks", url)
                        if VIEW_LINK:
                            buttons.buildbutton("Lihat Tautan", urls)
                if BUTTON_FOUR_NAME is not None and BUTTON_FOUR_URL is not None:
                    buttons.buildbutton(f"{BUTTON_FOUR_NAME}", f"{BUTTON_FOUR_URL}")
                if BUTTON_FIVE_NAME is not None and BUTTON_FIVE_URL is not None:
                    buttons.buildbutton(f"{BUTTON_FIVE_NAME}", f"{BUTTON_FIVE_URL}")
    ...
    def edit_telegraph(self):
        ...
        for content in self.telegraph_content :
            ...
            Telegraph(access_token=telegraph_token).edit_page(path = self.path[prev_page],
                                 title = 'KenzoMcW Search',
                                 author_name='KenzoMcW',
                                 author_url='https://t.me/kenzomcwbot',
    ...
    def drive_list(self, fileName):
        ...
        if response["files"]:
            ...
            if len(self.telegraph_content) == 0:
                return "Tidak Ada Hasil yang Ditemukan ❌", None
    ...
    def count(self, link):
        ...
        try:
            ...
            if drive_file['mimeType'] == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'<b>Nama Berkas: </b><code>{name}</code>'
