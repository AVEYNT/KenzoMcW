...
![GitHub watchers](https://img.shields.io/github/watchers/AVEYNT/KenzoMcW)
![Docker Pulls](https://img.shields.io/docker/pulls/aveynata13/kangnipispython?label=Docker%20Pull)
[![BOT](https://img.shields.io/badge/Join%20Channel-!-red)](https://t.me/kenzomcwbot)

**KenzoMcW** is a _multipurpose_ Telegram Bot writen in Python for mirroring files on the Internet to our beloved Google Drive. Based on [python-aria-mirror-bot](https://github.com/lzzy12/python-aria-mirror-bot)
